"""Stable quadratic spline topology for the authored open double-bowl model.
...
COUNTS={'uni0437':[5,4,4,4,3,5,4,3,3,3,3,4], 'uni0417':[4,4,5,5,4,4,5,3,3,3,3,4], 'three':[4,3,5,4,4,5,4,4,3,3,3,5]}
